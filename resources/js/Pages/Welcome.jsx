...
export default function Welcome({ auth, laravelVersion, phpVersion }) {
    ...
    return (
        <>
            <Head title="Welcome" />
            <div className="min-h-screen bg-gradient-to-r from-blue-500 to-purple-600 text-black/50 dark:text-white/50">
                <img
                    id="background"
                    ...
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        <header className="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                            ...
                            <nav className="-mx-3 flex flex-1 justify-end">
                                <Link
                                    href="/Food/Addtocart"
                                    className="rounded-md px-3 py-2 text-white bg-green-500 ring-1 ring-transparent transition hover:bg-green-600 focus:outline-none focus-visible:ring-[#FF2D20] mr-3"
                                >
                                    ไปที่ตะกร้าสินค้า
                                </Link>
                                {auth.user ? (
...
<footer className="mt-auto py-4 bg-gray-900 text-white text-center text-sm">
